...
import { Tent, MapPin, Calendar, Star, Phone, Mail, Instagram, Facebook, Twitter } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-background text-foreground font-sans">
            ...
            <nav className="border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
                <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xl font-bold tracking-tight">CampNature</span>
                    </div>
                    <div className="hidden md:flex items-center gap-6 text-sm font-medium">
                        <a href="#features" className="hover:text-primary transition-colors">Fasilitas</a>
                        <a href="#locations" className="hover:text-primary transition-colors">Lokasi</a>
            ...
            <section className="relative py-20 md:py-32 overflow-hidden">
                ...
                <div className="container relative z-10 mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6">
                        Temukan Ketenangan di <span className="text-primary">Alam Bebas</span>
                    </h1>
                    <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
                        Nikmati pengalaman camping terbaik dengan fasilitas lengkap dan pemandangan alam yang memukau. Reservasi tempat camping impian Anda sekarang.
                    </p>
            ...
            <section id="features" className="py-20 bg-muted/50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground">Fasilitas terbaik untuk kenyamanan camping Anda.</p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                title: "Tenda Premium",
                                description: "Sewa tenda berkualitas tinggi yang tahan air dan nyaman untuk segala cuaca."
                            },
                            {
                                icon: <MapPin className="h-10 w-10 text-primary" />,
                                title: "Lokasi Strategis",
                                description: "Spot camping dengan pemandangan terbaik, dekat sungai, dan akses mudah."
                            },
                            {
                                icon: <Star className="h-10 w-10 text-primary" />,
                                title: "Fasilitas Lengkap",
                                description: "Toilet bersih, listrik, wifi area, dan keamanan 24 jam tersedia."
                            }
                        ].map((feature, index) => (
                            <div key={index} className="bg-card text-card-foreground rounded-lg border p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            <section id="locations" className="py-20">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold tracking-tight mb-4">Pilihan Spot Camping</h2>
                        <p className="text-muted-foreground">Jelajahi berbagai lokasi menarik yang kami tawarkan.</p>
                    </div>
            ...
            <section className="py-20 bg-primary text-primary-foreground">
                <div className="container mx-auto px-4 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6">Siap untuk Petualangan Berikutnya?</h2>
                    <p className="text-lg mb-10 opacity-90 max-w-2xl mx-auto">
                        Jangan lewatkan kesempatan untuk menikmati keindahan alam. Pesan tempat Anda sekarang sebelum kehabisan!
                    </p>
                    <Link
                        href="/register"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                        <div>
                            <div className="flex items-center gap-2 mb-4">
                                <Tent className="h-6 w-6 text-primary" />
                                <span className="text-xl font-bold">CampNature</span>
                            </div>
                            <p className="text-sm text-muted-foreground">
                                Platform reservasi camping ground terbaik untuk pengalaman outdoor yang tak terlupakan.
                            </p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-muted-foreground">
                                ...
                                <li className="flex items-center gap-2">
                                    <Mail className="h-4 w-4" /> info@campnature.com
                                </li>
                                <li className="flex items-center gap-2">
                                    <MapPin className="h-4 w-4" /> Bogor, Jawa Barat
                                </li>
                            </ul>
                        </div>
                        <div>
